...
namespace ConsoleApp1
{
    class LibraryController
    {
        ...
        LibraryId: string updateLibraryId = Console.ReadLine();
            ...
            SeatCount: string libraryNewNSeatCount = Console.ReadLine();

                int seatCount;
                bool isSeatCount = int.TryParse(libraryNewNSeatCount, out seatCount);

                if (isSeatCount || libraryNewNSeatCount == "")
                {
                    bool isSeatCountEmpty = string.IsNullOrEmpty(libraryNewNSeatCount);
